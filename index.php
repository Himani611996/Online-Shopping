...
<body>
    ...
    <div class="main_wrapper">
        ...
        <div>
            ...
            <div id="left_sidebar" class="content-wrapper" style="background-color:#880E4F;height:700px;">
        	...
        	<div id="right_content" style="background-color:#FFF;height:700px;">
        ...
        <h1 style="color:black; padding-top:30px;text-align:center;height:10px;">&copy; 2017 *  SHOPIF BY THEME UNDERGROUND MEDIA  * </h1>
